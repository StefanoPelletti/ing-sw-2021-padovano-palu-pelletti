                                                ...
                                                if (basic) {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        if (!Halo.checkResource(textList, 1, false))
                                                            System.out.println("That's not a valid basic output!");
                                                        else {
...
//ACTION CHANGE DEPOT CONFIG
                                            case 4: {
                                                ...
                                                System.out.println(" actual depot: ");
                                                System.out.println(Halo.myPlayerRef.getWarehouseDepot());
...
class LocalPhase
{
    ...
    public Phase run()
    {
        ...
        {
            execute = true;
            if(Halo.gameSRV.isLeaderBoardEnabled())
            {
                Halo.yourTurn = false;
            }
            ...
            if(Halo.gameSRV.isMiddleActive()) {
                if (Halo.gameSRV.isLeaderCardsObjectEnabled()) {
                    ...
                    ArrayList<LeaderCard> cards = Halo.gameSRV.getLeaderCardsObject().getCards();
                    ArrayList<LeaderCard> list = new ArrayList<>();
    ...
    private boolean checkShowCommand(List<String> textList) {
        ...
        if (textList.size() == 4) {
            ...
            try {
                ...
                if (Integer.parseInt(textList.get(2)) > Halo.gameSRV.getPlayerList().size()) {
                    System.out.println(Halo.ANSI_RED + " > Sorry, the player number is above the maximum." + Halo.ANSI_RESET);
                    return false;
                }
